    ...
    def incremental_train(self, data_manager):
        ...
        if self._cur_task==0:
            train_dataset = data_manager.get_dataset(
                ...
                source="train",appendent=self._get_memory(),one_shot=False
            )
        else:
            train_dataset = data_manager.get_dataset(
                np.arange(self._known_classes, self._total_classes),
                source="train",appendent=self._get_memory(),one_shot=True
            )
            logging.info("trainset :{}".format(train_dataset.data))
