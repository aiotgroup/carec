...
class LwF(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        # logging.info("weights:{}".format(self._network.fc.bias))
        # logging.info("weights:{}".format(self._network.convnet.last_conv.weight))
    ...
    def plot_tsne(self,args,data_manager):
        ...
        plt.legend()
        plt.savefig("checkpoint/tsne_lwf_"+str(self._cur_task)+".jpg")
