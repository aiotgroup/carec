...
baseline_wifi = [95.07*0.01*15, 39.09*0.01*25, 26.54*0.01*35, 20.86*0.01*45, 18.33*0.01*55]
icarl_wifi = [94.85*0.01*15, 72.51*0.01*25, 65.86*0.01*35, 56.01*0.01*45, 56.57*0.01*55]
ucir_wifi = [94.89*0.01*15, 79.4*0.01*25, 71.37*0.01*35, 58.85*0.01*45, 60.2*0.01*55]
bic_wifi = [93.37*0.01*15, 74.13*0.01*25, 58.63*0.01*35, 52.58*0.01*45, 53.67*0.01*55]
...
our_wifi = [95.07*0.01*15, 83.56*0.01*25, 75.48*0.01*35, 64.12*0.01*45, 65.10*0.01*55]
...
plt.plot(x, icarl_wifi, color=(13/255, 76/255, 109/255), marker='o', markersize=20, linewidth=8, label='iCaRL')
